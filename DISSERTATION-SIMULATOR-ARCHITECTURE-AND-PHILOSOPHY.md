...
| Safety Hook | GroundedClaim 검증 + Hallucination Firewall + query_step.py 결정론적 라우팅 |
...
### 4.2 인프라 스크립트 (63개 프로덕션 + 2개 공유 모듈)
...
| `query_step.py` | **Step Execution Registry** — 210-step 결정론적 agent/tier/critic/pCCS 매핑 (H-1~H-4 할루시네이션 원천봉쇄) |
